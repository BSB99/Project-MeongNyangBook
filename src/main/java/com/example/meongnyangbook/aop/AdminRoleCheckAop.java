...
public class AdminRoleCheckAop {
  ...
  @Around("deleteReport() || getReports() || createNotice() || getNotices() || updateNotice() || deleteNotice() || createItem() || updateItem() || deleteItem() || createInquiryComment() || updateInquiryComment() || deleteInquiryComment() || findOrderLists()")
