...
public class AdminRoleCheckAop {
  ...
  @Pointcut("execution(* com.example.meongnyangbook.shop.inquiry.inquiryComment.controller.InquiryCommentController.createInquiryComment(..))")
  private void createInquiryComment() {
  }

  @Pointcut("execution(* com.example.meongnyangbook.shop.inquiry.inquiryComment.controller.InquiryCommentController.updateInquiryComment(..))")
  private void updateInquiryComment() {
  }

  @Pointcut("execution(* com.example.meongnyangbook.shop.inquiry.inquiryComment.controller.InquiryCommentController.deleteInquiryComment(..))")
